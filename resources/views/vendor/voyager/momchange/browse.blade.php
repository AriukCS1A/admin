        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-bordered">
                <div class="panel-heading">
                    <h3 class="panel-title">Momchange List</h3>
                    <div class="panel-actions">
                        <a href="{{ route('voyager.momchange.create') }}" class="btn btn-success">➕ Add New</a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->cycle }}</td>
                                <td>
                                    <a href="{{ route('voyager.momchange.edit', $data->id) }}" class="btn btn-sm btn-primary">✏️</a>
                                    <form action="{{ route('voyager.momchange.destroy', $data->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
