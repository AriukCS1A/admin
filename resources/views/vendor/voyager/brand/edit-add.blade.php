...
<div class="page-content container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form action="@if(isset($dataTypeContent->id)){{ route('voyager.brand.update', $dataTypeContent->id) }}@else{{ route('voyager.brand.store') }}@endif" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="cloudinary-upload">📷 Upload Brand Image </label>
