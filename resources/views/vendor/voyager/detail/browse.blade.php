        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-bordered">
                <div class="panel-heading">
                    <h3 class="panel-title">Detail List</h3>
                    <div class="panel-actions">
                        <a href="{{ route('voyager.detail.create') }}" class="btn btn-success">➕ Add New</a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->head }}</td>
                                <td>{{ $data->full }}</td>
                                <td>{{ $data->advice_id }}</td>
                                <td>
                                    <a href="{{ route('voyager.detail.edit', $data->id) }}" class="btn btn-sm btn-primary">✏️</a>
                                    <form action="{{ route('voyager.detail.destroy', $data->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
