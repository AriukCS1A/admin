...
<div class="page-content container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form action="@if(isset($dataTypeContent->id)){{ route('voyager.babydev.update', $dataTypeContent->id) }}@else{{ route('voyager.babydev.store') }}@endif" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="cloudinary-upload">📷 Upload Babydev Image </label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="month" class="form-control">{{ $dataTypeContent->month ?? '' }}</textarea>
                        </div>
